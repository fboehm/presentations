...
```{r vitruvian, eval = TRUE, echo = FALSE, out.height=450, out.width=600}
...
```{r attie, eval = TRUE, echo = FALSE, out.height=450, out.width=600}
...
```{r mpp, eval = TRUE, echo = FALSE, out.height=400, out.width=600}
##############################
# HS (light background)
# from kbroman/QTLfigs
##############################
